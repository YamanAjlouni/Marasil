...
import './ReturnsRetrieval.scss'
import { InputText } from 'primereact/inputtext';
import { ReturnsRetrievalNewOrder } from './returnsRetrievalNewOrder/ReturnsRetrievalNewOrder';
import { ReturnsRetrievalRefusedOrder } from './returnsRetrievalRefusedOrder/ReturnsRetrievalRefusedOrder';
import { ReturnsRetrievalSubmittedOrder } from './returnsRetrievalSubmittedOrder/ReturnsRetrievalSubmittedOrder';
import { MantineProvider } from '@mantine/core';

export const ReturnsRetrieval = () => {
	const [activeCard, setActiveCard] = useState(1);

	return (
		<div className='returnsRetrieval-out-container'>
			<div className='returnsRetrieval-top-container'>
				<div onClick={() => setActiveCard(1)} className='returnsRetrieval-card' >
					<div className='returnsRetrieval-right-container'>
						<div>0</div>
						<div>طلب جديد</div>
					</div>
					<div className='returnsRetrieval-left-container'>
				...
				<div onClick={() => setActiveCard(2)} className='returnsRetrieval-card'>
					<div className='returnsRetrieval-right-container'>
						<div>0</div>
				...
				<div onClick={() => setActiveCard(3)} className='returnsRetrieval-card'>
					<div className='returnsRetrieval-right-container'>
						<div>0</div>
						<div>طلب مرفوض</div>
					</div>
			...
			<div className='returnsRetrieval-search-bar'>
				<div className="returnsRetrieval-search-container">
				...
				<div className='returnsRetrieval-search-button'>
					<button>تصدير</button>
				</div>
			</div>
			<div className='returnsRetrieval-bottom-container'>
				<MantineProvider
					withGlobalStyles
					withNormalizeCSS
					theme={{
				...
				>
					{activeCard === 1 && <ReturnsRetrievalNewOrder />}
					{activeCard === 2 && <ReturnsRetrievalSubmittedOrder />}
					{activeCard === 3 && <ReturnsRetrievalRefusedOrder />}
				</MantineProvider>
			</div>
