...
import './ReturnsReplacingSubmittedOrder.scss'

export const ReturnsReplacingSubmittedOrder = () => {
    ...
    return (
        <div className="returnsReplacingSubmittedOrder-out-container">
