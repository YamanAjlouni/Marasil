...
import './ShipmentsFilterContainer.scss';
...
export const ShipmentsFilterContainer = () => {
    ...
    return (
        <div className="shipmentsFilterContainer-out-container">
            <div className="shipmentsFilterContainer-top-container">
                <div className="shipmentsFilterContainer-search-container">
                    <span className="p-input-icon-left">
                        <i className="pi pi-search" />
                        <InputText
                            className="shipmentsFilter-input"
                            placeholder="ابحث برقم الطلب أو رقم الشحنة أو معلومات العميل , ثم انقر ادخال"
                        />
                    </span>
                </div>
                <div className="shipmentsFilterContainer-date-picker">
                    <Calendar
                        value={dates}
                        ...
                        showButtonBar
                        className="shipmentsFilterContainer-calender custom-calendar"
            ...
            <div className="shipmentsFilterContainer-bottom-container">
                <div className='shipmentsFilterContainer-dropdown-out-container'>
                ...
                <div className='shipmentsFilterContainer-buttons-container'>
                    <a href="/">
